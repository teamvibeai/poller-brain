 ...
 *
 * Usage:
 *   npx tsx remove-reaction.ts emoji_name
 *   npx tsx remove-reaction.ts --channel C123 --message_ts 123.456 emoji_name
 */
...
async function main() {
  await slackApi('reactions.remove', { channel, timestamp: messageTs, name: emoji })
  succeed()
}
